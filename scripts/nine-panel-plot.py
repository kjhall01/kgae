...
tc3 = xr.concat([src.open_pdo().sel(time=slice("1940-01-01", pd.Timestamp(2014,12,31))).mean('dataset'), src.open_oni().sel(time=slice("1940-01-01", pd.Timestamp(2014,12,31))), src.open_npi().rolling(time=24, center=False).sum().sel(time=slice("1940-01-01", pd.Timestamp(2014,12,31)))], 'mode')
