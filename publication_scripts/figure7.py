...
def plot_joint_extremes_figure_v2(
    ...
    *,
    ...
    titles = {
        ...
        "BL": "CP Cold Anomaly",  # bottom-left
        "TR": "CP Warm Anomaly",  # top-right
    ...
    for key, ax in order:
        ...
        ds = xr.open_dataset('supplemental/climate_mode_patterns.nc').sel(mode=['E-Index', 'C-Index', 'ONI']).pattern
    ...
    corner_labels = {
        ...
        (0.03, 0.01): "CP Cold Anomaly",  # bottom-left
        (0.97, 0.99): "CP Warm Anomaly",  # top-right
...
if __name__ == "__main__":
    ...
    fig.savefig("figures/figure7_ia-de.pdf", dpi=300, bbox_inches="tight")
    plt.show()
