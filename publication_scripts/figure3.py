...
ERA5_SST_PATH = "/Users/kylehall/Desktop/Data/era5/era5.sst.pacific.1x1.1940-2023.nc"
...
def main():
    ...
    cb1.set_label(r"Linear response ($K$)")
    ...
    cb2.set_label(r"Nonlinear response ($K$)")
    ...
    cb3.set_label(r"Self state-dependence ($K$)")

    out = "figures/figure3_lbvfds.pdf"
